...
def mapScan(spec_scan: spec.SpecDataFileScan, instrument_path: str, detector_path: str):
    """
...
def mapScanPoint(point, scan, rsm_params, angles, instrument_reader, detector_reader):
    """
